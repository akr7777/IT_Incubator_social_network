...
const Navbar:React.FC<NavbarPropsType> = (props) => {
    ...
    return(
        <div className={s.nav}>
            ...
            { props.loginName && <div className={s.name_label}> {props.loginName} </div> }
            ...
            { props.isAuth && <div className={s.loguot_div}>{ <button onClick={props.logoutProcedure}>LOGOUT</button> }</div> }
